...
resource "aws_instance" "mc_uat_web_1" {
  ...
  user_data = <<-EOF
    ...
    echo "<html><body><h1>mc UAT Application - Web Server 1</h1></body></html>" > /var/www/html/index.html
  EOF
}

resource "aws_instance" "mc_uat_web_2" {
  ami                    = "ami-0c1e21d82fe9c9336"
  instance_type          = "t3.micro"
  ...
  user_data = <<-EOF
    ...
    systemctl start httpd
    systemctl enable httpd
    echo "<html><body><h1>mc UAT Application - Web Server 2</h1></body></html>" > /var/www/html/index.html
  EOF
}
...
resource "aws_instance" "mc-uat_1" {
  ...
  user_data = <<-EOF
    ...
    systemctl start httpd
    systemctl enable httpd
    echo "<html><body><h1>mc UAT Application - App Server 1</h1></body></html>" > /var/www/html/index.html
  EOF
}
...
resource "aws_instance" "mc-uat_2" {
  ...
  user_data = <<-EOF
    ...
    systemctl start httpd
    systemctl enable httpd
    echo "<html><body><h1>mc UAT Application - App Server 2</h1></body></html>" > /var/www/html/index.html
  EOF
}
...
#   s3_bucket = "mc-uat-app2"           # Correct bucket name
...
#         ],
#         Resource = [
#           "arn:aws:s3:::mc-uat-app2",                    # Allow access to the bucket
#           "arn:aws:s3:::mc-uat-app2/lambda.zip"          # Allow access to the specific object
#         ]
#       }
#     ]
#   })
