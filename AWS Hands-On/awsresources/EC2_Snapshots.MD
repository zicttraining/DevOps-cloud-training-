...
```text
Name        : NameAMI_2
Description : NameAMI_2
```

- Click AMI section from left hand menu and show `NameAMI_2`

- After NameAMI creation process is completed, click snapshot section from left-hand menu.

-  Show that AWS has created a new snapshot for newly created 'NameAMI_2` image.
...
- First go to the AMI section  from left-hand menu and say to not to do together.

- Select the NameAMI_4

- Click on permission and Click on  "Make public "

- After a while it will be public. Send the AMI ID from slack

- Now go to Launch Instance-----> Choose AMI------> Community AMI, and paste the "ID of AMI" to the search bar 
